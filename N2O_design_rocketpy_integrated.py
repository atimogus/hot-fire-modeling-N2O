...
N_ORFICE_OX = 9
N_ORFICE_F = 9
DRY_WEIGHT = 15 #kilograms (wirhout )
LAUNCH_RAIL_ANGLE = 84 #degrees
DRAG_COEFF = 0.75 # for mach M, Cd is = https://www.nakka-rocketry.net/RD_body.html
LOSS = 7 # percent
L_D_ratio = 15 # tank lenght / body diameter ratio
# body_diameter  = 130.43 mm, tank_height  = 1956.45 mm, fuel_tank_diameter  = 57.63 mm
